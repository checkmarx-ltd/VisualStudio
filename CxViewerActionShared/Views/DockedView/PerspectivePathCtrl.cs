...
namespace CxViewerAction2022.Views.DockedView
{
    ...
    public partial class PerspectivePathCtrl : UserControl, IPerspectivePathView
    {
        ...
        public void BindData(int index)
        {
            ...
            {
                file = Assembly.GetExecutingAssembly().GetManifestResourceStream("CxViewerAction2022.Resources.down.gif");
                fileEmpty = Assembly.GetExecutingAssembly().GetManifestResourceStream("CxViewerAction2022.Resources.empty.gif");
            }
            //End
