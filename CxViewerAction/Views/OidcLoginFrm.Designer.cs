...
namespace CxViewerAction.Views
{
    partial class OidcLoginFrm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.OidcLoginCtrl1 = new CxViewerAction.Views.DockedView.OidcLoginCtrl();
			this.SuspendLayout();
			// 
			// oidcLoginCtrl1
			// 
			this.OidcLoginCtrl1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.OidcLoginCtrl1.Location = new System.Drawing.Point(0, 0);
			this.OidcLoginCtrl1.Name = "oidcLoginCtrl1";
			this.OidcLoginCtrl1.Size = new System.Drawing.Size(494, 573);
			this.OidcLoginCtrl1.TabIndex = 0;
			// 
			// OidcLoginFrm
			// 
			...
			this.Controls.Add(this.OidcLoginCtrl1);
		...
		public OidcLoginCtrl OidcLoginCtrl1 { get => oidcLoginCtrl1; set => oidcLoginCtrl1 = value; }
	}
}