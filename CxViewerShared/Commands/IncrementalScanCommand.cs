...
namespace CxViewerVSIX.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class IncrementalScanCommand : CommandBase /*: IPluginObserver, IDisposable*/
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// Scan Logic.
        /// </summary>
        private IncrementalScanLogic _logic = new IncrementalScanLogic();
        ...
        private IncrementalScanCommand(Package package) : base(package)
        {
        ...
        /// </summary>
        public static IncrementalScanCommand Instance
        {
            get;
            private set;
        }
      ...
      /// <summary>
        ...
        {
            Instance = new IncrementalScanCommand(package);
        }
